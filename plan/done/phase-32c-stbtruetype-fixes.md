...
- [x] SDF capability guard added to BmFont.cs pipeline
- [x] ModuleInitializer trimmer-safe for AOT/WASM publish
- [x] JsonSerializer AOT-compatible in BmFontBinaryFormatter
- [x] Microsoft.Win32 import isolated from WASM assembly loading
- [x] Options mutation fixed (clone before mutating)
