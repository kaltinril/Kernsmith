...
internal sealed class ConvertCommand
{
    ...
    private static void ShowHelp()
    {
        Console.WriteLine("""
            ...
            Usage: bmfontier convert <input> -o <output> [--format <text|xml|binary>]
            ...
            Examples:
              bmfontier convert myfont.fnt -o myfont.xml --format xml
              bmfontier convert myfont.fnt -o output/myfont.bin --format binary
            """);
    }
}
