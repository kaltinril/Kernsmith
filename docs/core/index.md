...
- <xref:KernSmith.BmFont>.BeginIncremental() / .ResumeIncremental() -- start a <xref:KernSmith.BmFontIncrementalSession> for [runtime glyph addition](incremental-glyph-addition.md) without moving existing placements
